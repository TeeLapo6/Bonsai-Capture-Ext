...
export function getRunArtifactPaths(runDir: string) {
  return {
    ...
    exportGraph: path.join(runDir, 'export_graph.json'),
    exportMarkdown: path.join(runDir, 'export_markdown.md'),
    exportPackage: path.join(runDir, 'export_package.json'),
    exportToon: path.join(runDir, 'export_toon.json'),
    exportValidation: path.join(runDir, 'export_validation.json'),
